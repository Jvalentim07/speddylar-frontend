       ...
       <div style={{ height: '100%'}}>
         {
           ...
           <div style={{ display: 'flex', height: '100%', justifyContent: 'center', alignItems: 'center' }}>
            <Spinner animation="border" role="status" style={{ color: '#FF8120'}}>
              <span className="visually-hidden">Loading...</span>
            </Spinner>
          </div>
         :
          <div style={{ zIndex: '1' }} className="mainContent">
          ...
          {/* Serviços da Pagina */}
          <div  className="content-1" style={{ backgroundColor: 'rgba(0, 0, 0, 0.79)', padding: '100px'}}>
